...
# coq_makefile AbbrevA.v DetermA.v DynamicSemA.v EnvLibA.v HoareA.v IdModTypeA.v InvertA.v ModLEnvA.v ModNat1A.v ModNEnvA.v PRelLibA.v RelLibA.v SReducA.v StaticSemA.v STypingA.v Test_Convert.v Test_LEnv.v Test_Nat1.v THoareA.v TRInductA.v TSoundnessA.v WeakenA.v -o Makefile -Q .  
#
